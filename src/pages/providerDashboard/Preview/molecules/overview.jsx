  ...
  return (
    <Box sx={{ flexGrow: 1  }}>
      <Grid container spacing={4}>
        ...
        <Grid sx={{marginTop:"-200px", backgroundColor:"#314154"}} xs>
          <ZeroWidthStack />
        </Grid>
      </Grid>
    </Box>
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        {Array.from(Array(3)).map((_, index) => (
          <Grid xs={3} sm={4} md={6} key={index}>
            {index === 1 && <BasicCard heading={"Recent Review"} content={"Lorem ipsum dolor, sit amet!"} />}
